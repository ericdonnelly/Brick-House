...
def main():
    ...
    if request.method == "POST":
        ...
        # copy image file to 'static/new_images' directory after renaming file based on: category of the highest prediction percentage, followed by prediction percentage,
        ...
        new_image_path = f'static/new_images/{best_guess_category}/{new_image_name}'
        ...
        # copy renamed image file to 'static/new_images' directory
    ...
    return render_template('index.html', data=data, form_submit = form_submit)
